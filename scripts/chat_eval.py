...
# -----------------------------------------------------------------------------
# Categorical evaluation loop. We can just check the logits for correct answer
...
def run_categorical_eval(task_object, tokenizer, model, batch_size, max_problems=None):
    ...
    for i in range(ddp_rank, num_batches, ddp_world_size):
        ...
        #Prepare a batch of problems, collate them as they will be of different lengths
