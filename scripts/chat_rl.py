...
def get_batch():
    ...
    for example_idx in itertools.cycle(rank_indices):
        ...
        # Get the full conversation including the user and assistant messages
        conversation = train_task[example_idx]

        # Tokenize the full conversation by deleting the last assistant message to prime the assistant for completion

        tokens = tokenizer.render_for_completion(conversation=conversation)
        ...
        masks = []
        num_sampling_steps = args.num_samples // args.device_batch_size # go sequential to prevent OOMs
        ...
        # Stack up these sequences into python tensor
