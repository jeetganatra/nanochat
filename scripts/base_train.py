...
model = build_model_meta(depth=args.depth)
...
# Build reference model of d12 and upscale from there
d12_ref = build_model_meta(12) # creates the model on meta device
D_REF = args.target_param_data_ratio * get_scaling_params(d12_ref) # compute-optimal d12 training horizon in tokens (measured empirically by karpathy)
B_REF = 2**19 # optimal batch size at d12 ~= 524,288 tokens (measured empirically by karpathy)
